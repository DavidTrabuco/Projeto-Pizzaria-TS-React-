...
export const HomeStyles = {
    ...
    subtitle: "text-orange-400 text-xs font-semibold tracking-[0.3em] uppercase drop-shadow-md",

    title: "text-white text-5xl lg:text-7xl font-extrabold uppercase tracking-tight leading-none drop-shadow-2xl",
