export const AppPromotionStyles = {
    ...
    badge: `
        text-[#f5c518] text-xs tracking-widest font-mono uppercase
        mb-4 animate-pulse drop-shadow-md
    `,
    ...
    btn: `
        ...
        hover:border-[#f5c518] hover:bg-[#1a1a1a]
        hover:-translate-y-1 hover:shadow-lg hover:shadow-yellow-500/20
        active:scale-95
    `,
    ...
    image: `
        w-64 lg:w-80 rounded-3xl object-cover
        ring-1 ring-white/10
        shadow-2xl
        transition-all duration-500
        hover:scale-105 hover:shadow-[0_0_40px_rgba(245,197,24,0.2)]
    `,
}
