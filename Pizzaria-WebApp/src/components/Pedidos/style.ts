export const OrderStyle = {
    ...
    section: `
        ...
        bg-gradient-to-br from-red-950 to-black
        px-6 py-16
    `,
    ...
    closeBtn: `
        ...
        text-gray-500 hover:text-white text-lg
    ...
    label: `
        text-orange-400 text-xs tracking-widest font-mono uppercase
        mb-2 text-center drop-shadow-sm
    ...
    title: `
        ...
        text-center mb-2 drop-shadow-lg
        animate-fade-up delay-3
    `,

    divider: `
        w-16 h-1
        bg-orange-500 mx-auto mb-4 rounded-full
    ...
    itemLinha: `
        ...
        py-[6px] border-b border-white/5
    `,
